...
HD_PWD='/home/gerac/ArquitecturaDeComputadoras/TPfinal_MIPS/TPfinal_MIPS.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log eq2_sop.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source eq2_sop.tcl
