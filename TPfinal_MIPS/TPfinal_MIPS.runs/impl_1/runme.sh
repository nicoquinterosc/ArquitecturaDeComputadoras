...
HD_PWD='/home/gerac/ArquitecturaDeComputadoras/TPfinal_MIPS/TPfinal_MIPS.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log eq2_sop.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source eq2_sop.tcl -notrace
